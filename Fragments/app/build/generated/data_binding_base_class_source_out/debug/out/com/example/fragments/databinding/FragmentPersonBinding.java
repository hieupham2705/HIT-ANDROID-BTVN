...
public final class FragmentPersonBinding implements ViewBinding {
  ...
  private FragmentPersonBinding(@NonNull FrameLayout rootView) {
  ...
  public static FragmentPersonBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_person_, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static FragmentPersonBinding bind(@NonNull View rootView) {
    ...
    return new FragmentPersonBinding((FrameLayout) rootView);
  }
}
